...
\usepackage[left=1.4cm,right=1.4cm,top=1.4cm,bottom=1cm,includeheadfoot]{geometry}


\begin{document}
	\input{\npbase gemeinsam/titelseiten/tipps}
	
	\newpage
	
	\Large
	Hinweise und Tipps für die Klausur:
	\large
	...
	\begin{itemize}
		...
		\item \fat{Logiklücken in Aufgaben ausnutzen ist vollkommen legitim!} \\		
		Wenn du einen Fehler in einer Aufgabe findest oder denkst, dass du einen Weg genommen hast, der nicht bedacht war und der die Aufgabe z.B. deutlich vereinfacht hat, schreibe einen Satz, wie du darauf kommst. Logischerweise gibt es aber keine Punkte, wenn dieser Weg dann falsch ist.
		
		\item \fat{Überprüft eure Lösungen mit Bauchgefühl:} \\
		Es gibt Aufgaben, da kann man aus einer Grafik ablesen, was die Lösung sein müsste. In einer Klausur gab es z.B. eine einfach Quadratur Aufgabe und man konnte aus der Grafik sehen, dass die Fläche unter der Funktion negativ und betragsmäßig recht klein sein musste. Wenn man dann halt auf Zahlen wie $12$ kommt, sollte man sich seine Rechnung vielleicht noch einmal durchgehen. Das gleiche gilt auch für Verständnisaufgaben! Wenn man nämlich (als Beispiel) erkennt, dass seine Lösung falsch ist aber nicht die Zeit hat, diese zu korrigieren, schreibt als Text hin, dass ihr erkannt habt, dass die Lösung falsch sein muss. Dafür gibt es Punkte, weil wir sehen, dass ihr es verstanden habt.
		...
		\item \fat{Aufbau}:
		\begin{itemize}
			\item In der Klausur wird es 5-6 Abschnitte geben mit jeweils mehreren Teilaufgaben. Jeder Abschnitt repräsentiert meist ein Oberkapitel. Dementsprechend gibt es mehrere Themen, die nicht abgefragt werden.
			...
			\item Die letzte Aufgabe der Klausur ist \fat{immer eine Programmieraufgabe}. Hierbei gilt, dass man in Java oder Java-ähnlichem Pseudocode geschrieben werden muss. Solange ihr nicht von irgendwelchen Packages ausgeht, die euch alle Funktionalitäten abnehmen und euer Code verständlich ist, alles super! \\
			...
			\item Es gibt immer 2-3 Teilaufgaben, die sehr schwierig sind bzw. \fat{nicht in den Tutorien} behandelt worden sind. Macht euch darüber keine Sorge, ohne diese kann man immer noch eine 1,3 schreiben.
		\end{itemize}
		...
		Bei einigen Aufgaben stehen Hinweise. Die stehen da meist nicht ohne Grund also nutzt sie! Falls ihr aber eine Aufgabe ohne den Hinweis lösen könnt, dann ist das auch super, nur eher unwahrscheinlich :D
...
%									& Kondition/Stabilität 			& 					 & \\
	...
	\Large
	Liste an typischen Fehlern / Tipps:
	\large
	...
	\begin{itemize}
		...
		\item Für die Limes Untersuchung kann man häufig "L'Hopital" anwenden.
		...
		\item Implizites Euler-Verfahren \fat{ist NICHT} genauer als Explizites Euler-Verfahren. Beide haben Ordnung 1. Das implizite ist stabiler, aber nicht genauer!
